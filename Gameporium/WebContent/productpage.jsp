							 ...
							 <ul class="list-group list-group-flush">
							 	...
							 	<li class="list-group-item bg-light">
							 		<div class="row">
								 		...
								 		<div class="col-lg-7 col-xs-12">#${currentProduct.codiceProdotto}</div>
							 		</div>
							 	</li>
							 	<li class="list-group-item bg-light">
							 		<div class="row">
							 			<div class="col-lg-5" style="font-weight:bold">Marca:</div>
								 		<div class="col-lg-7">${currentProduct.produttore}</div>
							 		</div>
							 	</li>
							 	<li class="list-group-item bg-light">
							 		<div class="row">
							 			<div class="col-lg-5" style="font-weight:bold">Durata:</div>
								 		<div class="col-lg-7">${currentProduct.durata}</div>
							 		</div>
							 	</li>
							 	<li class="list-group-item bg-light">
							 		<div class="row">
							 			<div class="col-lg-5" style="font-weight:bold">Età consigliata:</div>
								 		<div class="col-lg-7">${currentProduct.etaConsigliata}+ anni</div>
							 		</div>
							 	</li>
							 	<li class="list-group-item bg-light">
							 		<div class="row">
							 			<div class="col-lg-5" style="font-weight:bold">Disponibilità:</div>
								 		<div class="col-lg-7">#${currentProduct.disponibilita}</div>
							 		</div>
							 	</li>
